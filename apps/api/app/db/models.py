...
class LoginCode(Base):
    """Saytga telefon orqali kirish uchun bir martalik kod (bot yuboradi).

    Kodning o'zi saqlanmaydi — faqat SHA-256 hash. Baza sizib chiqsa ham
    tayyor kodlar qo'lga tushmaydi.
    """
